...
export const AboutSection = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Level up across seasons and unlock exclusive titles, rewards, and fame!",
      color: "text-accent",
    ...
    },
    {
      ...
      description: "Buy, sell, and trade with other players in a fully player-driven economy!",
      color: "text-success",
