  ...
  const ranks = [
    {
      ...
      icon: "🟢",
      popular: false,
      stripeUrl: "https://buy.stripe.com/test_4gM4gscX66Djc1mfCI6AM00",
      features: ["+2 Homes", "Chat colors", "Basic kits", "Priority join"],
    },
    {
      name: "Premium Rank",
      price: "$3.99",
      ...
      icon: "🔵",
      popular: true,
      stripeUrl: "https://buy.stripe.com/test_14A7sEg9i6Dje9u6286AM01",
      features: [
        "+5 Homes",
        "Premium kits",
        "Particle effects",
    ...
    },
    {
      ...
      icon: "🟣",
      popular: false,
      stripeUrl: "https://buy.stripe.com/test_cNi4gs3mw2n36H24Y46AM02",
      features: [
        "+10 Homes",
        "Elite kits",
        "Custom particles",
    ...
    },
    {
      ...
      icon: "🟠",
      popular: false,
      stripeUrl: "https://buy.stripe.com/test_7sY6oA2is9Pv7L68ag6AM03",
      features: [
        "Unlimited homes",
        "Instant teleport",
        "Legendary kits",
